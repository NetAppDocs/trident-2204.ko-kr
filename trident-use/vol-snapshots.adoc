...
. 볼륨 스냅샷 CRD를 생성합니다.
+
Kubernetes 1.20 이상의 경우 v5.0 이상의 스냅샷 구성 요소와 함께 v1 스냅샷 CRD를 사용하십시오. Kubernetes 버전 1.18 및 1.19의 경우 v3.0.3 스냅샷 구성요소와 함께 v1beta1을 사용하십시오.
...
+
Kubernetes 1.20 이상의 경우 v5.0 이상을 사용합니다. Kubernetes 버전 1.18 및 1.19의 경우 v3.0.3을 사용합니다
